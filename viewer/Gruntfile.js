...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    bgShell: {
      ...
      execIngester: {
        cmd: 'AWS_ACCESS_KEY_ID=DummyAccessKey AWS_SECRET_ACCESS_KEY=DummySecretKey mvn exec:exec',
        execOpts: {
          cwd: '<%= ingester.src %>'
        }
      },
      ...
      development: {
        ...
        constants: {
          ENV: {
            ...
            useCognitoIdentity: 'true' === nconf.get('USE_COGNITO_DEV'),                       
            userId: 'localUser',
            accessKeyId: 'DummyAccessKey',
            secretAccessKey: 'DummySecretKey',
            dynamoDBRegion: nconf.get('DYNAMODB_REGION_DEV'),
            dynamoDBEndpoint: nconf.get('DYNAMODB_ENDPOINT_DEV'),
            photosTable: nconf.get('TABLE_PHOTOS'),
            userVotesTable: nconf.get('TABLE_USER_VOTES')
          }
        }
      },
      test: {
        ...
        constants: {
          ENV: {
            ...
            identityPoolId: nconf.get('COGNITO_IDENTITY_POOL_ID'),
            unauthRoleArn: nconf.get('COGNITO_UNAUTH_ROLE_ARN'),            
            useCognitoIdentity: 'true' === nconf.get('USE_COGNITO_TEST'),                                   
            userId: 'localUser',            
            accessKeyId: 'DummyAccessKey',
            secretAccessKey: 'DummySecretKey',
      ...
      production: {
        ...
        constants: {
          ENV: {
            ...
            identityPoolId: nconf.get('COGNITO_IDENTITY_POOL_ID'),
            unauthRoleArn: nconf.get('COGNITO_UNAUTH_ROLE_ARN'),
            useCognitoIdentity: 'true' === nconf.get('USE_COGNITO_PROD'),
            userId: 'localUser',            
            accessKeyId: 'DummyAccessKey',
            secretAccessKey: 'DummySecretKey',
  ...
  grunt.registerTask('prepare_tables', 'Creates tables in DynamoDB Local and ingest image data', function () {
    grunt.task.run([
      ...
      'bgShell:installIngester',
      'bgShell:execIngester',
      'bgShell:voteRandomly'
    ]);
  });
